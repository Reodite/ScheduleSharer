...
describe('parseMeetingPatterns', () => {
  ...
  it('splits reading-break cells into two patterns', () => {
    const cell =
    ...
    expect(patterns.every((p) => p.startMin === 570 && p.endMin === 660)).toBe(true);
  });
